const canvasElement = document.getElementById('pyramid-canvas');
if (!(canvasElement instanceof HTMLCanvasElement)) {
  throw new Error('Pyramid canvas not found');
}
...
const vertices = new Float32Array([
  // base vertices       // colors
  -0.5, 0.0, -0.5, 1.0, 0.0, 0.0, 0.5, 0.0, -0.5, 0.0, 1.0, 0.0, 0.5, 0.0, 0.5, 0.0, 0.0, 1.0, -0.5,
  0.0, 0.5, 1.0, 1.0, 0.0,
  // apex vertex
  0.0, 0.8, 0.0, 1.0, 0.0, 1.0,
]);

const indices = new Uint16Array([0, 1, 2, 0, 2, 3, 0, 1, 4, 1, 2, 4, 2, 3, 4, 3, 0, 4]);
